...
set my_verilog_files [list alu.v cache.v cache_controller.v cla_4b.v cla_16b.v control.v decode.v dff.v execute.v EXMEM.v fetch.v final_memory.syn.v forwarding_unit.v four_bank_mem.v fullAdder_1b.v hazard_detection_unit.v IDEX.v IFID.v memc.syn.v memory.v mem_system.v memv.syn.v MEMWB.v nand2.v proc.v reg1.v reg2.v reg3.v reg4.v reg5.v reg16.v regFile.v regFile_bypass.v shifter.v wb.v xor2.v  ]
